...
<style>
    #<?php echo $widget_id; ?> .mecas-upcoming-grid {
...
<div class="mecas-upcoming-wrapper" 
     ...
     data-hide-past="<?php echo esc_attr($atts['hide_past_events']); ?>">

    <?php if ($show_category_tabs && !empty($categories)): ?>
    <!-- Category Tabs -->
    <div class="mecas-category-tabs">
        <button type="button" class="mecas-category-tab active" data-category="">
            <?php echo esc_html($all_tab_text); ?>
        </button>
        <?php foreach ($categories as $cat): ?>
        <button type="button" class="mecas-category-tab" data-category="<?php echo esc_attr($cat->slug); ?>">
    ...
    <?php if (!empty($events)): ?>
    <div class="mecas-upcoming-grid mecas-featured-grid">
    ...
    <div class="mecas-no-results">
        <p class="mecas-no-results-text"><?php esc_html_e('No upcoming events found.', 'mec-starter-addons'); ?></p>
    </div>
    <?php endif; ?>
</div>
