<?php
/**
 * MEC Starter Addons - Elementor Featured Events Widget
 * Displays featured events in a grid
 */

if (!defined('ABSPATH')) exit;

class MECAS_Featured_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'mecas_featured';
    }

    public function get_title() {
        return __('MEC Featured Events', 'mec-starter-addons');
    }
    ...
    protected function render() {
        ...
        $atts = array(
            ...
            'widget_id' => 'mecas-featured-' . $this->get_id(),
        );
        
        echo do_shortcode('[mec_featured_events ' . $this->build_shortcode_attrs($atts) . ']');
    }
